...
const Navbar = () => {  
  ...
  return (
    ...
    <nav className={`fixed w-full left-0 top-0 z-[999] duration-500 ${sticky ? 'bg-white/60 text-gray-900' : "text-white"}`}>
      <div className="flex item-center justify-between">
        <div className="flex items-center mx-7">
          <h4 className="text-4xl uppercase font-bold">
            W<span className="text-cyan-600">AY</span>S
          </h4>
        </div>        
        ...
        <div
          ...
          className={`z-[999] ${open ? "text-gray-800" : "text-gray-100"} text-3xl md:hidden m-5`}>
